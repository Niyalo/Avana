...
const Topbar = (props) => {
  ...
  return (
    <div className="w-[360px] h-[42px] justify-start items-start inline-flex">
        ...
        {props.label4 && <div className={`text-base cursor-pointer w-[160px] text-black150 px-3 py-2 rounded-br-sm rounded-bl-sm shadow-md text-center ${toggle==4? `text-white50 bg-primary shadow-none` : `hover:bg-white100 bg-white50 border-b border-l border-r border-grey50`}`} onClick={() => handleClick(4)}>{props.label4}</div>}
