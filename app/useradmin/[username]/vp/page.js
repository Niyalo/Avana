...
const vp = () => {
  ...
  const handlePopup = (e, project_name) => {
    ...
    .map(items => (
        <div id='popupOpener' onClick={() => handlePopup(e, items.project_name)} className="w-full cursor-pointer bg-white0 px-8 py-4 border border-grey50 rounded-sm justify-start items-center gap-6 inline-flex hover:shadow-sm hover:scale-[1.01] hover:bg-white100">
